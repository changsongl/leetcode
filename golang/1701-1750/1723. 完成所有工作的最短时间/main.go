...
func main() {
	...
	//fmt.Println(minimumTimeRequired([]int{11, 2, 20, 18, 2, 1, 7, 11, 7, 10}, 9))
	...
	fmt.Println(minimumTimeRequired([]int{9899456, 8291115, 9477657, 9288480, 5146275, 7697968, 8573153, 3582365, 3758448, 9881935, 2420271, 4542202}, 9))
}
